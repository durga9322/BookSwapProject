      ...
      {showAdd && (
        <form onSubmit={addBook} style={{
            ...
            {newBook.image_url ? (
              <div style={{ marginTop: 10, display: "flex", alignItems: "center", gap: 12 }}>
                <img
                  ...
                  style={{
                    width: 55, height: 80, objectFit: "cover",
              ...
              <div style={{
                ...
                How to get URL: Search book on Google Images → right click image → Copy image address → paste above
              </div>
            )}
          </div>
          ...
          <div style={{ marginTop: 8, padding: "8px 12px", background: "#f0fdf4",
            ...
            Example URL for Atomic Habits: https://m.media-amazon.com/images/I/81wgcld4wxL.jpg
          </div>
